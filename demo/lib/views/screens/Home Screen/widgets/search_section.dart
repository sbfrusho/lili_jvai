...
//     final languageFontSize = getResponsiveFontSize(14);
//     final hintFontSize = getResponsiveFontSize(14);
//     final suggestionFontSize = getResponsiveFontSize(14);
...
//                     GestureDetector(
//                       onTap: controller.triggerAISearch,
//                       child: Container(
...
//           // --- Download & Copy Buttons using CustomButton ---
//           Obx(() {
//             if (!controller.showTranslationSection.value) return const SizedBox.shrink();
//             return Row(
//               children: [
//                 Expanded(
//                   child: CustomButton(
